...
E_D("DROP TABLE IF EXISTS `zmb_enewsmemberadd`;");
E_C("CREATE TABLE `zmb_enewsmemberadd` (
...
E_D("replace into `zmb_enewsmemberadd` values('1',0x323534393035353237,'','','','','','','1','','','','','','','','0',0x312e3139322e32312e38,'1545295279',0x312e3139322e32312e38,'1',0x3430343633,0x3430343633);");
