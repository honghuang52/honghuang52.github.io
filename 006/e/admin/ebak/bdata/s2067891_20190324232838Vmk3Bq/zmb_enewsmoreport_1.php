...
E_D("DROP TABLE IF EXISTS `zmb_enewsmoreport`;");
E_C("CREATE TABLE `zmb_enewsmoreport` (
...
E_D("replace into `zmb_enewsmoreport` values('1',0xe4b8bbe8aebfe997aee7abaf,'','','','','0','0','0','0','','0','0');");
