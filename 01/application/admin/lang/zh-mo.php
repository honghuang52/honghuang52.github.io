...
return [
    ...
    'New slide grouping' => '新建幻燈片分組',
    'Slide grouping' => '幻燈片分組',
    'Group name' => '分組名',
    'Group names can only be composed of letters' => '分組名只能由字母組成',
    'Slide width' => '幻燈片寬度',
    'Slide height' => '幻燈片高度',
    'Group name must be filled in' => '分組名必須填寫',
    'Slide width must be filled in' => '幻燈片寬度必須填寫',
    'Slide height must be filled in' => '幻燈片高度必須填寫',
    'Slide width must be a number' => '幻燈片寬度必須是數字',
    'Slide height must be a number' => '幻燈片高度必須是數字',
    'The group name already exists, please change one' => '分組名已經存在，請換一個',
    'Are you sure you want to delete the slide group? It cannot be recovered after deletion!' => '您確定要將幻燈片組刪除嗎?刪除後不可恢復!',
    'Modify slide grouping' => '修改幻燈片分組',
    'Please select a slide group' => '請選擇幻燈片組',
    'All groupings' => '所有分組',
