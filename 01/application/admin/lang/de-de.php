...
return [
    ...
    'New slide grouping' => 'Neue Foliengruppierung',
    'Slide grouping' => 'Foliengruppierung',
    'Group name' => 'Gruppenname',
    'Group names can only be composed of letters' => 'Gruppennamen können nur aus Buchstaben bestehen',
    'Slide width' => 'Folienbreite',
    'Slide height' => 'Schieben Sie Höhe',
    'Group name must be filled in' => 'Gruppenname muss ausgefüllt werden',
    'Slide width must be filled in' => 'Breite muss ausgefüllt werden',
    'Slide height must be filled in' => 'Höhe muss ausgefüllt werden',
    'Slide width must be a number' => 'Width muss eine Zahl sein',
    'Slide height must be a number' => 'Die Höhe muss eine Zahl sein',
    'The group name already exists, please change one' => 'Der Gruppenname existiert bereits, bitte ändern Sie einen',
    'Are you sure you want to delete the slide group? It cannot be recovered after deletion!' => 'Möchten Sie die Foliengruppe wirklich löschen? Sie kann nach dem Löschen nicht wiederhergestellt werden!',
    'Modify slide grouping' => 'Ändern Sie die Foliengruppierung',
    'Please select a slide group' => 'Bitte wählen Sie eine Foliengruppe',
    'All groupings' => 'Alle Gruppierungen',
