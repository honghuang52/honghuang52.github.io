...
return [
    ...
    'New slide grouping' => '新しいスライドのグループ化',
    'Slide grouping' => 'スライドのグループ化',
    'Group name' => 'グループ名',
    'Group names can only be composed of letters' => 'グループ名は文字だけで構成できます',
    'Slide width' => 'スライド幅',
    'Slide height' => 'スライドの高さ',
    'Group name must be filled in' => 'グループ名を入力してください',
    'Slide width must be filled in' => 'スライドの幅を記入する必要があります',
    'Slide height must be filled in' => 'スライドの高さを記入する必要があります',
    'Slide width must be a number' => 'スライドの幅は数字でなければなりません',
    'Slide height must be a number' => 'スライドの高さは数字でなければなりません',
    'The group name already exists, please change one' => 'グループ名は既に存在します。名前を変更してください',
    'Are you sure you want to delete the slide group? It cannot be recovered after deletion!' => 'スライドグループを削除してよろしいですか？削除後に元に戻すことはできません。',
    'Modify slide grouping' => 'スライドのグループ化を変更する',
    'Please select a slide group' => 'スライドグループを選択してください',
    'All groupings' => 'すべてのグループ',
